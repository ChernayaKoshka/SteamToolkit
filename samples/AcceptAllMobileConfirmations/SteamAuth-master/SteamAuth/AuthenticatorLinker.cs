...
namespace SteamAuth
{
    ...
    public class AuthenticatorLinker
    {
        ...
        public LinkResult AddAuthenticator()
        {
            ...
            string response = SteamWeb.MobileLoginRequest(APIEndpoints.SteamToolkit_BASE + "/ITwoFactorService/AddAuthenticator/v0001", "POST", postData);
        ...
        public FinalizeResult FinalizeAddAuthenticator(string smsCode)
        {
            ...
            while (tries <= 30)
            {
                ...
                string response = SteamWeb.MobileLoginRequest(APIEndpoints.SteamToolkit_BASE + "/ITwoFactorService/FinalizeAddAuthenticator/v0001", "POST", postData);
